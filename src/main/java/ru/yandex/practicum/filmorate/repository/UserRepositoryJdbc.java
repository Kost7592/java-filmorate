...
public class UserRepositoryJdbc implements UserRepository {
    ...
    public User updateUser(User updatedUser) {
        final String UPDATE_QUERY = "UPDATE USERS SET USER_NAME = :u_name, EMAIL = :u_email, LOGIN = :u_login, " +
                "BIRTHDAY = :u_bday WHERE USER_ID = :u_id";

        MapSqlParameterSource mapSqlParameterSource = new MapSqlParameterSource();
        mapSqlParameterSource.addValue("u_id", updatedUser.getId());
        mapSqlParameterSource.addValue("u_name", updatedUser.getName());
        mapSqlParameterSource.addValue("u_email", updatedUser.getEmail());
        mapSqlParameterSource.addValue("u_login", updatedUser.getLogin());
        mapSqlParameterSource.addValue("u_bday", updatedUser.getBirthday());
    ...
    public void addFriend(User user, User friend) {
        ...
        if (checkForIncludeFriends(user.getId(), friend.getId())) {
    ...
    public List<User> getFriends(User user) {
        final String SELECT_QUERY = "SELECT * FROM USERS AS u INNER JOIN FRIENDS AS uf  ON uf.FRIEND_ID = u.USER_ID " +
                "WHERE uf.USER_ID = :u_id "; //+dB
        MapSqlParameterSource mapSqlParameterSource = new MapSqlParameterSource();
        mapSqlParameterSource.addValue("u_id", user.getId());
    ...
    private boolean checkForIncludeFriends(Long userId, Long friendId) {
        boolean ret = true;
