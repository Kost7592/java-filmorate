...
import ru.yandex.practicum.filmorate.repository.mappers.FilmWithoutGenreExtractor;
...
public class FilmRepositoryJdbc implements FilmRepository {
    ...
    public List<Film> getLikedFilms(int count) {
        ...
        Map<Long, Film> mapFilms = jdbc.query(SELECT_QUERY, mapSqlParameterSource, new FilmWithoutGenreExtractor());
        return new ArrayList<Film>(mapFilms.values());
    }
